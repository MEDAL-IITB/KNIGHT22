...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        # model_dir = "/home/Drive2/KNIGHT/knight/results/2_task2_clinical_segmentation"
        # checkpoint = "/home/Drive2/KNIGHT/knight/results/2_task2_clinical_segmentation/checkpoint_80_epoch.pth"
        # data_path = "/home/Drive3/knight/knight_test_data/"
        # cache_path = "/home/Drive3/knight/cache"
        # # split = "baseline/splits_final.pkl"
        # output_filename = "/home/Drive3/knight/2_task2_predictions.csv"
        # predictions_key_name = "model.output.head_0"
        # task_num = 2 # 1 or 2

        model_dir = "/home/Drive2/KNIGHT/knight/results/10pca_drop_0.5_method_activation_lr_0.002_wd_0.01"
        checkpoint = "/home/Drive2/KNIGHT/knight/results/10pca_drop_0.5_method_activation_lr_0.002_wd_0.01/checkpoint_last_epoch.pth"
        data_path = "/home/Drive3/knight/knight_test_data/"
        cache_path = "/home/Drive3/knight/cache"
        # split = "baseline/splits_final.pkl"
        output_filename = "/home/Drive3/knight/3_task1_predictions.csv"
        predictions_key_name = "model.output.head_0"
        task_num = 1 # 1 or 2
        split = None
