...
if task_num == 1:
    num_epochs = 100
    num_classes = 2
    learning_rate = 3*1e-4 if use_data['clinical'] else 1e-5
    imaging_dropout = 0.9
    clinical_dropout = 0.9
    fused_dropout = 0.9
...
def main():
    ...
    data_path = '/home/Drive3/knight/'
    cache_path = '/home/Drive3/knight/cache_segfeatures_10/'
    results_path = '/home/Drive2/KNIGHT/knight/results/task1_10pca_drop_{}_method_activation_lr_{}_wd_{}'.format(clinical_dropout,learning_rate,weight_decay)
    ...
    if use_data['clinical']:
        append_features = [("data.input.clinical.all", 21)]
    else:
