...
class KiCClinicalProcessor(FuseProcessorBase):
    ...
    def __call__(self, sample_desc: Hashable):
        ...
        # listt = ['case_00156','case_00158','case_00203','case_00216','case_00246','case_00263','case_00271','case_00272']
        # 
        # if(sample_desc not in listt):
...
# 
        feat = '/home/Drive3/knight/knight_test_data/Output_new_Test/{}.npy'.format(sample_desc)
        # feat = '/home/Drive3/knight/Output_PCA_10_norm/{}.npy'.format(sample_desc)
        np_data = np.load(feat)
        torch_data = torch.Tensor(np_data)
        feat_10 = torch_data
        sample_data['features'] = feat_10
